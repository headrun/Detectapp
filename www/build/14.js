...
var ProfilePage = /** @class */ (function () {
    function ProfilePage(navCtrl, navParams, toastCtrl) {
        ...
        this.group_id = [];
        this.COMETCHAT_DATA = '';
        this.URL = 'https://api.cometondemand.net/api/v2/createUser';
    }
    ...
    ProfilePage.prototype.saveprofile = function () {
        ...
        __WEBPACK_IMPORTED_MODULE_2_firebase__["database"]().ref('userDetails/').push(obj).then(function (res) {
            console.log(res);
            _this.COMETCHAT_DATA = 'UID=' + phoneNumber + '&name=' + _this.firstName + ' ' + _this.lastName;
            var ajax = new XMLHttpRequest();
            // ajax.withCredentials = true;
            console.log(_this.COMETCHAT_DATA);
            ...
            ajax.send(_this.COMETCHAT_DATA);
        });
