...
var ChatPage = /** @class */ (function () {
    ...
    ChatPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-chat',template:/*ion-inline-start:"/Users/suraj/Documents/projects/HumainDiagnostics/src/pages/chat/chat.html"*/'<ion-header>\n  <div>\n    <div class="head-container">\n      <img src="assets/imgs/green_header.png" id="green_header">\n      <img src="assets/imgs/detect_black.png" id="detect_black">\n      <span class="head-text">CHATS</span>\n    </div>\n  </div>\n </ion-header>\n\n<ion-content padding>\n\n    <ion-fab bottom right (click)="newChat()">\n      <button ion-fab mini color="secondary"><ion-icon name="add" ></ion-icon></button>\n    </ion-fab>\n\n</ion-content>\n\n<footer [ic_active]="4"></footer>\n'/*ion-inline-end:"/Users/suraj/Documents/projects/HumainDiagnostics/src/pages/chat/chat.html"*/,
        }),
